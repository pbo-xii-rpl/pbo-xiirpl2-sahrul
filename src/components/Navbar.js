...
export default function App() {
    ...
    <nav className="navbar bg-blue-600 py-12">
      ...
      <div>
      <div className="font-mono text-4xl my-12 mt-20 font-mono text-white text-center">Saya seorang front-end engineer, back-end <br/>engineer, dan juga UI designer</div>
